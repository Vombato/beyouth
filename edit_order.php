...
<html>
	...
	<body onload="checkAmount();">
		...
		<form action="report.php" method="POST" onsubmit="return checkValuesType(document.getElementById('name').value, document.getElementById('tableNum').value);">
            ...
            Nome cliente: <input type="text" name="name" id="name" value="<?php echo $costumerName; ?>">
            <p id="errorName" style="color:red; font-size: 15px;"></p>
            
            Numero tavolo: <input type="text" name="tableNum" id="tableNum" value="<?php echo $costumerTable; ?>">
            ...
            <h3>Totale: <input type="text" name="totCheck" id="totCheck" value="<?php echo $totalCheck; ?>" readonly></h3>
